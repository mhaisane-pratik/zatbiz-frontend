...
import WeddingThemePreview from './WeddingThemePreview';
...
export default function WeddingSelectorModal({
  ...
  // Category currently shown in the full-screen "see before use" preview overlay
                ...
                >
                  ...
                  <div className="p-4 flex-1 flex flex-col justify-between text-left font-sans">
                    ...
                    <div className="grid grid-cols-2 gap-2">
                      <button
                        onClick={() => setPreviewCategory(cat.name)}
                        className="w-full py-2.5 text-[10px] font-black bg-white border border-slate-200/80 hover:border-indigo-400 text-slate-600 rounded-xl transition uppercase tracking-wider flex items-center justify-center gap-1 cursor-pointer"
                      >
                        👁 Preview
                      </button>
                      <button
