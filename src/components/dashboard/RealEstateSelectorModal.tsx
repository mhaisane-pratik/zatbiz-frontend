...
import RealEstateThemePreview from './RealEstateThemePreview';
...
export default function RealEstateSelectorModal({
  ...
  // Theme currently shown in the full-screen "see before use" preview overlay
                      ...
                      <div className="p-5 flex-1 flex flex-col justify-between space-y-4">
                        ...
                        <div className="grid grid-cols-2 gap-2">
                          <button
                            ...
                            className="w-full py-2.5 text-[10px] font-black bg-white border border-slate-200/80 hover:border-indigo-400 text-slate-650 rounded-xl transition uppercase tracking-wider flex items-center justify-center gap-1 cursor-pointer"
                          >
                            👁 Preview
                          </button>
                          <button
      ...
      {previewTheme && (
        <RealEstateThemePreview
          ...
          onUse={() => {
            ...
            onSelectCategory(selectedCategory as string, t.id, t.primaryColor);
          }}
        />
      )}
    </div>
