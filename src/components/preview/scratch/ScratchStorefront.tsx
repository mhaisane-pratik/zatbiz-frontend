...
export default function ScratchStorefront({
  ...
  const handleLoginSubmit = (e: React.FormEvent) => {
    ...
    // Admin access on generated sites has been removed. Owners manage the
    // site from the main ZATBIZ dashboard. Block legacy admin login and treat
    // everyone else as a normal customer.
    if (['admin@gmail.com', 'agent@gmail.com', 'broker@gmail.com'].includes(loginEmail.trim().toLowerCase())) {
      setLoginError('Admin management has moved to the main ZATBIZ dashboard.');
      return;
    }
    setCustomerSession({
      email: loginEmail,
