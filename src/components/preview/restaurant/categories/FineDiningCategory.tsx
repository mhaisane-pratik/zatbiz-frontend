...
export default function FineDiningCategory({
  ...
  const displayHeroImage = heroImage || '/restaurant_hero_gourmet.png';
  ...
  return (
    <div className={`min-h-screen bg-[#fbf7f2] text-[#1f1712] ${colors.selectionBg} selection:text-white`} style={{ fontFamily: "'Outfit', sans-serif" }}>
        ...
        >
          ...
          <div className="mx-auto grid min-h-[88vh] max-w-7xl items-center gap-12 px-6 py-12 sm:px-10 lg:grid-cols-[1.04fr_0.96fr] lg:px-16 lg:py-16">
            ...
            <div className="relative">
              ...
              <div className="relative overflow-hidden rounded-[34px] border border-[#e8ddd1] bg-white shadow-[0_30px_90px_-32px_rgba(25,17,14,0.15)]">
                <img
                ...
                <div className="absolute inset-x-0 bottom-0 p-5 sm:p-6">
                  <div className="flex flex-col gap-4 rounded-[28px] border border-white/40 bg-white/80 p-6 text-[#1f1712] backdrop-blur-xl sm:flex-row sm:items-center sm:justify-between shadow-lg">
                    <div>
                      <div className="text-[9px] uppercase tracking-[0.25em] text-[#c59b6d] font-bold">
                        Today's Special
                      </div>
                      <h2 className="mt-1.5 text-lg font-bold text-[#1f1712] leading-tight">Seasonal Gastronomy Plate</h2>
                      <p className="mt-1 max-w-xs text-[11px] leading-relaxed text-[#5f554c]">
                        Prepared fresh daily with hand-picked local ingredients.
                      </p>
                    </div>
                    <button
                      type="button"
                      onClick={() => setIsBookingModalOpen(true)}
                      className="rounded-full bg-[#1f1712] hover:bg-black px-5 py-2.5 text-[11px] uppercase tracking-wider font-semibold text-white transition duration-200 flex-shrink-0"
                    >
                      Reserve Table
                    </button>
                  </div>
