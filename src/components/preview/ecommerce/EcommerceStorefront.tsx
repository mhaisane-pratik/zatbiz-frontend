...
import EcommerceLanding from './landing/EcommerceLanding';
import EcommerceLogin from './login/EcommerceLogin';
import EcommerceAdminPortal from './dashboard/EcommerceAdminPortal';
import EcommerceUserPortal from './dashboard/EcommerceUserPortal';
...
export default function EcommerceStorefront({
  ...
  const [themeSettings, setThemeSettings] = useState({
    ...
    cardStyle: 'classic-bordered',
    layoutStyle: 'modern-grid',
    buttonRoundness: 'rounded-lg',
    bannerStyle: 'gradient-mesh'
  });
