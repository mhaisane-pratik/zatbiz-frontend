...
import FashionLogin from './FashionLogin';
import ElectronicsLogin from './ElectronicsLogin';
import FurnitureLogin from './FurnitureLogin';
import BeautyLogin from './BeautyLogin';
import RestaurantLogin from './RestaurantLogin';
import PharmacyLogin from './PharmacyLogin';
import PetLogin from './PetLogin';
import JewelryLogin from './JewelryLogin';
import GroceryLogin from './GroceryLogin';
import ScratchLogin from './ScratchLogin';
