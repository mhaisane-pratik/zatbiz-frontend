...
import FashionLanding from './FashionLanding';
import ElectronicsLanding from './ElectronicsLanding';
...
import PharmacyLanding from './PharmacyLanding';
import PetLanding from './PetLanding';
import JewelryLanding from './JewelryLanding';
import GroceryLanding from './GroceryLanding';
import ScratchLanding from './ScratchLanding';
