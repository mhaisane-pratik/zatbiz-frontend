              ...
              <table className="w-full text-left text-xs">
                ...
                <tbody className="divide-y divide-white/5 text-slate-350 font-semibold">
                  <tr className="hover:bg-white/[0.01]">
                    <td className="py-3 text-white">customer@example.com</td>
                    <td className="py-3">Valued Buyer</td>
                    <td className="py-3 text-indigo-400">Gold Tier</td>
                    <td className="py-3">
                      <span className="px-2 py-0.5 rounded-full text-[9px] font-black uppercase bg-green-500/10 text-green-400">Active</span>
                    </td>
                  </tr>
                </tbody>
              </table>
